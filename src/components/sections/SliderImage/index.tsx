...
const slides = [
    {
        ...
        illustration: "/slideshow/slideshow01.webp"
    },
    {
        ...
        illustration: "/slideshow/slideshow02.webp"
    },
    {
        title: 'Des programmes ancrés sur le développement du leadership et de l’entrepreneuriat',
        description: 'Les multinationales et organismes internationaux peinent à recruter dans notre Pays parce que la plupart de nos diplômés ne peuvent pas travailler en anglais qui est la langue la plus utilisée dans ces milieux professionnels qui offrent de meilleures opportunités et rémunérations.',
        illustration: "/slideshow/slideshow03.webp"
    },
    {
        title: 'Les inscriptions 2025-2026 sont ouvertes',
        description: 'Rejoignez l’excellence académique à l’USCITECH. Places limitées, inscrivez-vous dès maintenant.',
        illustration: "/students.jpg",
        cta: { label: "S'inscrire", href: "https://uscitech-cisnet.com/inscriptions/formulaire" }
    }
];
                                ...
                                <div className='max-w-[900px]'>
                                    ...
                                    {slide.cta &&
                                        <div className='mt-[20px]'>
                                            <Button type='primary' label={slide.cta.label} href={slide.cta.href} useAsLink />
                                        </div>
                                    }
                                </div>
                            </div>
